 ...
 * 
 * 
 * Slightly modified to accept 'n' for n queens, while default array created was int[4][4]. ---- (a)
 * */
public class NQueenProblem_GeeksforGeeks 
{ 
	final int N = 8; 
	 ...
	 * return true and	prints placement of queens in the form of 1s. 
...
//		System.out.println("");
		...
		NQueenProblem_GeeksforGeeks Queen = new NQueenProblem_GeeksforGeeks(); 
		Queen.solveNQ(); 
	} 
} 
